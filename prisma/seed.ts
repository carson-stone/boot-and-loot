...
async function main() {
  ...
  const cards: CardDef[] = [
    ...
    { name: "Decoy", cardType: "device", pool: "dynamic", costGold: 3, isOneTimeUse: true, description: "Dissolve 1 of your attention into the background noise. It stays in the Din but can no longer be traced back to you.", totalQuantity: 4, effects: [{ displayOrder: 0, effectType: "redirect_attention_to_filler", amount: 1 }] },
  ...
  const edges: { from: string; to: string; bidirectional: boolean; cost: number; requiresTool: string | null; description: string | null }[] = [
    ...
    { from: "Echoing Cavern", to: "Burial Chamber", bidirectional: false, cost: 1, requiresTool: null, description: "Floor collapses - one-way drop" },
