...
async function main() {
  ...
  const cards: CardDef[] = [
    ...
    { name: "Decoy", cardType: "device", pool: "dynamic", costGold: 3, isOneTimeUse: true, description: "One-time: move 1 of your attention to the shared filler pool.", totalQuantity: 4, effects: [{ displayOrder: 0, effectType: "redirect_attention_to_filler", amount: 1 }] },
